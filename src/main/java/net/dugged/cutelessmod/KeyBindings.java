...
public class KeyBindings {
    ...
    public static final KeyBinding dropItemsKey = new KeyBinding("key.cutelessmod.drop_items", KeyConflictContext.IN_GAME, Keyboard.KEY_NONE, Reference.NAME);
    ...
    public static void init() {
        ...
        ClientRegistry.registerKeyBinding(dropItemsKey);
    }
